...
export async function seedIfEmpty(): Promise<void> {
  ...
  const dosenData = [
    { _id: dosenIds[0], nidn: "0101019001", nama: "Dr. Arif Setiawan, M.T.", email: "arif@kampus.ac.id", prodi: "Teknik Informatika", jabatan: "Lektor Kepala", golongan: "IV/a", status: "aktif", keahlian: ["Machine Learning", "Data Science"], telepon: "08123456789", password: "dosen123", role: "dosen" },
    { _id: dosenIds[1], nidn: "0202029002", nama: "Prof. Siti Rahayu, Ph.D.", email: "siti@kampus.ac.id", prodi: "Sistem Informasi", jabatan: "Guru Besar", golongan: "IV/d", status: "aktif", keahlian: ["Database", "Enterprise Systems"], telepon: "08234567890", password: "dosen123", role: "dosen" },
    { _id: dosenIds[2], nidn: "0303039003", nama: "Dr. Budi Santoso, M.M.", email: "budi@kampus.ac.id", prodi: "Manajemen Bisnis", jabatan: "Lektor", golongan: "III/d", status: "aktif", keahlian: ["Strategic Management", "Finance"], telepon: "08345678901", password: "dosen123", role: "dosen" },
    { _id: dosenIds[3], nidn: "0404049004", nama: "Dr. Dewi Lestari, S.H., M.H.", email: "dewi@kampus.ac.id", prodi: "Hukum", jabatan: "Lektor Kepala", golongan: "IV/b", status: "aktif", keahlian: ["Hukum Perdata", "Hukum Bisnis"], telepon: "08456789012", password: "dosen123", role: "dosen" },
    { _id: dosenIds[4], nidn: "0505059005", nama: "dr. Rizki Pratama, Sp.PD.", email: "rizki@kampus.ac.id", prodi: "Kedokteran", jabatan: "Lektor", golongan: "III/c", status: "aktif", keahlian: ["Internal Medicine", "Cardiology"], telepon: "08567890123", password: "dosen123", role: "dosen" },
  ];
  ...
  const mahasiswaData = [
    { _id: mahasiswaIds[0], nim: "20210001", nama: "Ahmad Fauzi", email: "ahmad@student.kampus.ac.id", prodi: "Teknik Informatika", angkatan: 2021, semester: 7, ipk: 3.85, sks: 120, status: "aktif", telepon: "08111111111", alamat: "Jl. Merdeka No. 1, Jakarta", password: "mahasiswa123", role: "mahasiswa" },
    { _id: mahasiswaIds[1], nim: "20210002", nama: "Bella Safira", email: "bella@student.kampus.ac.id", prodi: "Sistem Informasi", angkatan: 2021, semester: 7, ipk: 3.72, sks: 118, status: "aktif", telepon: "08122222222", alamat: "Jl. Sudirman No. 5, Jakarta", password: "mahasiswa123", role: "mahasiswa" },
    { _id: mahasiswaIds[2], nim: "20220003", nama: "Cahyo Wibowo", email: "cahyo@student.kampus.ac.id", prodi: "Manajemen Bisnis", angkatan: 2022, semester: 5, ipk: 3.45, sks: 90, status: "aktif", telepon: "08133333333", alamat: "Jl. Gatot Subroto No. 10, Jakarta", password: "mahasiswa123", role: "mahasiswa" },
    { _id: mahasiswaIds[3], nim: "20220004", nama: "Diana Putri", email: "diana@student.kampus.ac.id", prodi: "Hukum", angkatan: 2022, semester: 5, ipk: 3.65, sks: 88, status: "aktif", telepon: "08144444444", alamat: "Jl. Thamrin No. 3, Jakarta", password: "mahasiswa123", role: "mahasiswa" },
    { _id: mahasiswaIds[4], nim: "20230005", nama: "Eko Prasetyo", email: "eko@student.kampus.ac.id", prodi: "Kedokteran", angkatan: 2023, semester: 3, ipk: 3.92, sks: 55, status: "aktif", telepon: "08155555555", alamat: "Jl. Rasuna Said No. 7, Jakarta", password: "mahasiswa123", role: "mahasiswa" },
    { _id: mahasiswaIds[5], nim: "20230006", nama: "Fitri Handayani", email: "fitri@student.kampus.ac.id", prodi: "Teknik Informatika", angkatan: 2023, semester: 3, ipk: 3.58, sks: 52, status: "aktif", telepon: "08166666666", alamat: "Jl. Kuningan No. 2, Jakarta", password: "mahasiswa123", role: "mahasiswa" },
  ];
  ...
  const adminData = [
    { nama: "Administrator Sistem", email: "admin@kampus.ac.id", role: "admin", password: "admin123", nim: "admin001" },
  ];
  await db.collection("admin").insertMany(adminData);

  const rektorData = [
    { nama: "Prof. Dr. H. Suyono, M.B.A.", email: "rektor@kampus.ac.id", role: "rektor", password: "rektor123", nim: "rektor001", jabatan: "Rektor Universitas Nusantara" },
  ];
