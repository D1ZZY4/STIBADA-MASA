...
function getGradeColor(grade: string) {
  if (grade === "A" || grade === "A-") return "bg-emerald-100 text-emerald-800 dark:bg-emerald-900/30 dark:text-emerald-300";
  if (grade === "B+" || grade === "B" || grade === "B-") return "bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-300";
  if (grade === "C+" || grade === "C") return "bg-yellow-100 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-300";
